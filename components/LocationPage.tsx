...
const LocationPage: React.FC<LocationPageProps> = ({ location }) => {
    ...
    useEffect(() => {
        const locationSchema = {
            ...
            "@type": "LocalBusiness",
            "@id": `https://Wissem7155hack.github.io/Northern-Property-maintenance/locations/${location.slug || location.city.toLowerCase()}#localbusiness`,
            "name": `Northern Property Maintenance - ${location.city}`,
            "description": `Professional yard care and maintenance in ${location.city}. Lawn mowing, seasonal cleanups, pressure washing, and gutter cleaning. Your local partner for property care.`,
            "image": "https://Wissem7155hack.github.io/Northern-Property-maintenance/images/logo.png",
            "telephone": "+12509815662",
            "email": "northernpropertymaintenancepg@gmail.com",
            "url": `https://Wissem7155hack.github.io/Northern-Property-maintenance/locations/${location.slug || location.city.toLowerCase()}`,
            "address": {
                "@type": "PostalAddress",
            ...
            "hasOfferCatalog": {
                "@type": "OfferCatalog",
                "name": `Property Maintenance Services in ${location.city}`,
    ...
    return (
        <div className="min-h-screen bg-stone-50">
            {/* SEO Head */}
            <SEOHead
                title={`Yard Care & Property Maintenance ${location.city} | Northern Property Maintenance ⭐ Professional Services`}
                description={`Expert property maintenance in ${location.city}. Lawn care, seasonal cleanups, pressure washing, and more. Free Quote: +1 (250) 981-5662. ${location.description}`}
                keywords={`property maintenance ${location.city}, yard care ${location.city}, lawn mowing ${location.city}, seasonal cleanups ${location.city}, pressure washing ${location.city}, Northern Property Maintenance, Prince George, BC`}
                canonical={`https://Wissem7155hack.github.io/Northern-Property-maintenance/locations/${citySlug}`}
            />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-earth-900">
                            Property Maintenance in {location.city}
                        </h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-serif text-earth-900 mb-6">
                                Your Property Maintenance Experts in {location.city}
                            </h2>
                            <p className="text-gray-700 text-lg leading-relaxed mb-6">
                                As your local property maintenance partner in {location.city} and {location.region},{' '}
                                we understand the unique needs of northern properties.
                                From detailed lawn care to professional pressure washing and seasonal cleanups,
                                we know what your property needs to stay in top shape. Whether it's a <strong>spring reset</strong>{' '}
                                or <strong>regular maintenance</strong> – we deliver excellence.
                            </p>
                        ...
                        <div>
                            <div className="aspect-w-16 aspect-h-12 rounded-lg overflow-hidden shadow-2xl">
                                <iframe
                                    ...
                                    title={`Map of ${location.city} - Northern Property Maintenance service area`}
                                ></iframe>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-16 md:py-24 bg-earth-900 text-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl md:text-5xl font-serif mb-6">
                        Ready for a beautiful property in {location.city}?
                    </h2>
                    <p className="text-xl text-gray-300 mb-10">
                        Contact us for a free quote. We look forward to helping you with your next cleanup!
                    </p>
