...
// --- Gallery Data (formerly blogPosts) ---
const blogPosts: BlogPost[] = [
  {
    id: '1',
    slug: 'lawn-care-project',
    title: 'Professional Lawn Care',
    excerpt: 'Detailed lawn mowing and yard maintenance for a clean, professional look.',
    date: '2024-03-15',
    image: img1,
    story: ['Maintaining a beautiful lawn requires consistency and attention to detail.'],
    tips: [],
    qa: []
  },
  {
    ...
    excerpt: 'Deep cleaning and debris removal to reset the property for the new season.',
    date: '2024-04-02',
    image: img2,
    story: ['Our seasonal cleanups ensure your yard is ready for whatever weather comes next.'],
    tips: [],
    qa: []
  },
  {
    id: '3',
    slug: 'pressure-washing-project',
    title: 'Surfaces Pressure Washing',
    excerpt: 'Removing years of buildup from driveways and walkways.',
    date: '2024-05-10',
    image: img14,
    story: ['Professional pressure washing can transform the curb appeal of any property.'],
    tips: [],
    qa: []
  },
  {
    ...
    excerpt: 'Expert trimming to maintain plant health and property aesthetics.',
    date: '2024-06-15',
    image: img20,
    story: ['Proper trimming is essential for healthy growth and a tidy appearance.'],
    tips: [],
    qa: []
  },
  {
    id: '5',
    slug: 'property-maintenance-pg',
    title: 'Yard Maintenance',
    excerpt: 'Regular property care services in Prince George.',
    date: '2024-07-20',
    image: img7,
    story: ['Consistent care keeps properties looking their best all year round.'],
    tips: [],
    qa: []
  },
  {
    ...
    excerpt: 'Reliable maintenance for commercial property outdoor spaces.',
    date: '2024-08-01',
    image: img8,
    story: ['Professional groundskeeping for local businesses.'],
    tips: [],
    qa: []
  }
];
      ...
      <div className="lg:hidden flex flex-col bg-stone-100">
        <div className="relative h-screen w-full flex flex-col justify-center items-center px-6 overflow-hidden">
          ...
          <div className="relative z-10 text-center flex flex-col items-center top-[-40px]">
            <span className="text-[#c5a26a] font-bold tracking-[0.2em] text-[10px] uppercase mb-4 animate-[fadeInUp_0.8s_ease-out]">
            ...
            <h1 className="text-6xl font-serif text-white leading-[1.1] animate-[fadeInUp_1s_ease-out] drop-shadow-lg">
              Northern <br />
              <span className="text-[#c5a26a] italic font-light block mt-2">Property Maintenance</span>
            </h1>
            ...
            <p className="text-white text-lg leading-relaxed max-w-[340px] mx-auto my-8 animate-[fadeInUp_1.3s_ease-out] font-medium drop-shadow-md">
              Expert yard care, seasonal cleanups, and pressure washing in Prince George. Call +1 (250) 981-5662 for a free quote!
            </p>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            <div className="max-w-2xl text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-serif text-white leading-[1.1] drop-shadow-2xl mb-6 md:mb-8 animate-[fadeInUp_1.2s_ease-out_forwards]">
                Northern
                <br />
                <span className="italic font-light text-gold-400">Property Maintenance</span>
              </h1>
              ...
              <p className="text-lg md:text-xl text-gray-200 font-light max-w-2xl border-l-2 border-gold-500 pl-4 md:pl-6 mb-8 md:mb-10 animate-[fadeInUp_1.4s_ease-out_forwards] mx-auto lg:mx-0">
                Spring is here — and after a long winter, your property deserves a reset. We offer professional lawn care, seasonal cleanups, and pressure washing. Contact us at +1 250-981-5662 for a free quote!
              </p>
  ...
  const services = [
    {
      ...
      desc: "Detailed lawn mowing and yard care services to keep your property looking its best throughout the season."
    },
    {
      icon: <Shovel className="w-6 h-6 md:w-8 md:h-8" />,
      title: "Cleanups & Sweeping",
      desc: "Light and full seasonal cleanups, including spring gravel sweeping to reset your property after winter."
    },
    {
      icon: <Leaf className="w-6 h-6 md:w-8 md:h-8" />,
      title: "Tree & Hedge Trimming",
      desc: "Professional trimming of trees and hedges to maintain health and aesthetic appeal."
    },
    {
      icon: <PencilRuler className="w-6 h-6 md:w-8 md:h-8" />,
      title: "Pressure & Soft Washing",
      desc: "Specialized cleaning process for driveways and surfaces to remove deep-set buildup while preserving integrity."
    },
    {
      icon: <Shovel className="w-6 h-6 md:w-8 md:h-8" />,
      title: "Gutter & Roof Care",
      desc: "Essential gutter cleaning and roof maintenance to protect your home from water damage and debris."
    },
    {
      icon: <Leaf className="w-6 h-6 md:w-8 md:h-8" />,
      title: "Seasonal Services",
      desc: "From spring resets to year-round maintenance, we are your one-stop solution for a clean and safe property."
    }
  ];
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-16">
        <RevealOnScroll>
          <div className="relative w-full max-w-lg mx-auto lg:mx-0">
            ...
            <img
              src={img1}
              alt="Work of Northern Property maintenance"
            ...
            <div className="absolute -bottom-6 -right-6 md:-bottom-10 md:-right-10 bg-white text-earth-900 p-4 md:p-8 shadow-xl max-w-xs hidden lg:block z-20">
              ...
              <p className="text-right mt-2 md:mt-4 font-bold text-gold-600 text-xs md:text-sm tracking-widest">— Northern Property maintenance</p>
            </div>
          </div>
        </RevealOnScroll>
        ...
        <div className="lg:w-1/2 space-y-6 md:space-y-8 mt-8 lg:mt-0">
          <RevealOnScroll delay={200}>
            ...
            <p className="text-gray-300 text-base md:text-lg font-light leading-relaxed mt-4 md:mt-6">
              At Northern Property Maintenance, we take pride in helping homeowners and businesses keep their properties clean, safe, and looking great year-round. From lawn care and pressure washing to roof maintenance, gutter cleaning, and seasonal cleanups, we're your one-stop solution in Prince George. Call or text +1 (250) 981-5662 for a free quote!
            </p>
            ...
            <div className="flex items-center gap-4 md:gap-6 p-4 md:p-6 bg-white/5 border border-white/10 rounded-sm mt-6 md:mt-8 backdrop-blur-sm hover:bg-white/10 transition-colors">
              <img
                src={img25}
                alt="Northern Property maintenance"
                className="w-28 h-19 md:w-48 md:h-30 object-cover border-2 border-gold-500 shadow-md"
              />
              <div>
                <h4 className="text-lg md:text-xl font-serif text-white">Northern Property Maintenance</h4>
                <p className="text-gold-500 text-xs font-bold uppercase tracking-widest mb-1 md:mb-2">Property Care & Maintenance</p>
                <p className="text-gray-400 text-xs italic">"Detail-focused service. Done right the first time."</p>
              </div>
            </div>

            <div className="space-y-4 md:space-y-6 mt-6 md:mt-8">
              {[
                { title: "Detail-Focused Results", desc: "We focus on clean, consistent results for every property we maintain." },
                { title: "Free Quotes", desc: "Call or text +1 (250) 981-5662 for a free estimate on your property care." },
                { title: "One-Stop Solution", desc: "From seasonal cleanups and lawn care to pressure washing and gutter cleaning." }
              ].map((item, i) => (
...
const Testimonials = () => {
  ...
  const allReviews = [
    { name: "Luis Arras", location: "Prince George, BC", rating: 5, time: "2 weeks ago", text: "Crew was always on time, did a professional job and was done before the schedule time given to us will keep recommending and using their services" },
    { name: "Mark T.", location: "Prince George, BC", rating: 5, time: "1 month ago", text: "Northern Property Maintenance did an incredible job on our spring cleanup. Professional, efficient, and the yard looks amazing. Highly recommend them for any property care." },
    { name: "David L.", location: "College Heights, BC", rating: 5, time: "2 months ago", text: "Hired them for hedge trimming and pressure washing. They have the right equipment and know-how. The driveway looks new again!" },
    { name: "Sarah J.", location: "Hart, BC", rating: 5, time: "3 months ago", text: "Great communication and excellent work on our lawn maintenance. Their team is top notch. They transformed our yard into a great outdoor space." },
    { name: "Mike R.", location: "Prince George, BC", rating: 5, time: "4 months ago", text: "We needed some gutter cleaning and gravel sweeping done. They handled it safely and quickly. Very impressed with their professionalism." },
    { name: "Jennifer P.", location: "Prince George, BC", rating: 5, time: "5 months ago", text: "Transformational work on our property. The lawn care and washing looks amazing. Reliable and fair pricing." }
  ];
...
const InteractiveMap = () => (
  <div className="w-full h-[300px] md:h-[500px] relative">
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d152542.4831610443!2d-122.92318041530263!3d53.89669528994503!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x538896067b579737%3A0x673105777709a3cf!2sPrince%20George%2C%20BC!5e0!3m2!1sen!2sca!4v1707923456789!5m2!1sen!2sca"
      width="100%"
      height="100%"
      style={{ border: 0 }}
      allowFullScreen
      ...
      title="Location in Prince George, BC"
...
const HomePage = () => (
  <>
    <SEOHead
      ...
      description="Expert yard care and maintenance services in Prince George. We offer lawn mowing, tree trimming, seasonal cleanups, and pressure washing. ✓ Free Quote ✓ Quality Work ✓ Reliable Service. Request a quote today!"
      keywords="yard care, lawn mowing, tree trimming, seasonal cleanups, pressure washing, Northern Property Maintenance, Prince George"
    />
    <Hero />
    <ServicesSection />
    <AboutPreview />
...
const ServicesPage = () => (
  <>
    <SEOHead
      title="Our Services – Property Maintenance | Northern Property Maintenance"
      description="Professional property maintenance services: ✓ Lawn Care ✓ Seasonal Cleanups ✓ Pressure Washing ✓ Gutter Cleaning. Quality service at fair prices. Contact us today!"
      keywords="property maintenance, lawn care, seasonal cleanups, pressure washing, gutter cleaning, Prince George"
    />
    <PageHeader
      title="Our Services"
      subtitle="Quality Property Care"
    ...
    <section className="py-12 md:py-20 bg-earth-900 text-center text-white">
      <div className="max-w-4xl mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-serif mb-4 md:mb-6">Ready to Reset Your Property?</h2>
        <p className="text-gray-300 mb-4 text-sm md:text-base">Northern Property Maintenance is ready to help with your next cleanup:</p>
        <ul className="text-gray-300 text-sm md:text-base mb-6 md:mb-8 max-w-2xl mx-auto text-left space-y-2">
          <li>✓ Lawn mowing & detailed yard care</li>
          <li>✓ Tree & hedge trimming</li>
          <li>✓ Light & full seasonal cleanups</li>
          <li>✓ Pressure & soft washing</li>
          <li>✓ Gutter cleaning & roof maintenance</li>
          <li>✓ Spring gravel sweeping</li>
        </ul>
        <p className="text-gold-500 font-bold text-lg mb-6">Call or text: +1 (250) 981-5662</p>
...
const ProjectsPage = () => (
  <>
    <SEOHead
      title="Projects & Gallery – Property Maintenance | Northern Property Maintenance"
      description="View our completed property maintenance and cleanup projects. ✓ Lawn Care ✓ Seasonal Cleanups ✓ Pressure Washing. See our quality work!"
      keywords="property maintenance projects, lawn care gallery, cleanup examples, pressure washing gallery, landscape maintenance"
    />
    <PageHeader
      title="Projects"
    ...
    <div className="bg-stone-50 py-12 md:py-20">
      <div className="max-w-7xl mx-auto px-4 text-center">
        <p className="text-gray-500 italic text-sm md:text-base">Selected projects from 2023-2025</p>
      </div>
    </div>
  </>
);
...
const AboutPage = () => (
  <>
    <SEOHead
      title="About Us – Property Maintenance Experts | Northern Property Maintenance"
      description="Learn more about Northern Property Maintenance. Your reliable partner for yard care and maintenance with professional service and guaranteed satisfaction in Prince George."
      keywords="property maintenance company, lawn care, Northern Property Maintenance, professional maintenance Prince George"
    />
    <PageHeader
      title="About Us"
      subtitle="Our Story"
        ...
        <div className="prose prose-sm md:prose-lg prose-stone mx-auto">
          ...
          <div className="flex flex-col items-center mb-8 md:mb-12">
            ...
            <div className="mt-4 md:mt-6 text-center">
              <h4 className="text-xl md:text-2xl font-serif text-earth-900">Northern Property Maintenance</h4>
              <p className="text-gold-500 text-xs md:text-sm font-bold uppercase tracking-widest">Property Care & Maintenance</p>
            </div>
          </div>

          <h3 className="text-2xl md:text-3xl font-serif text-earth-900 mb-4 md:mb-6 text-center">Excellence in Property Maintenance</h3>
          <p className="leading-loose text-gray-600 mb-4 md:mb-6 text-sm md:text-base">
            At Northern Property Maintenance, we take pride in helping homeowners and businesses keep their properties clean, safe, and looking great year-round. From lawn care and pressure washing to roof maintenance, gutter cleaning, and seasonal cleanups, we're your one-stop solution.
          </p>
          <p className="leading-loose text-gray-600 mb-4 md:mb-6 text-sm md:text-base">
            Your driveway and lawn are the first things people notice. We use specialized processes to safely remove deep-set buildup and contaminants while preserving the integrity of your surfaces. Every project receives personalized attention and a commitment to excellence. Call or text +1 (250) 981-5662 for a free quote!
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 py-8 md:py-12 text-center border-y border-gray-200 my-8 md:my-12">
            <div>
              <span className="block text-2xl md:text-4xl font-serif text-gold-500 mb-1 md:mb-2">3+</span>
              <span className="text-xs uppercase tracking-widest text-gray-500">Years of Experience</span>
            </div>
            <div>
              <span className="block text-2xl md:text-4xl font-serif text-gold-500 mb-1 md:mb-2">150+</span>
          ...
          <div className="bg-stone-50 p-6 md:p-8 rounded-lg mt-8 md:mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-center">
              <div>
                ...
                <a href="tel:+12509815662" className="text-earth-900 hover:text-gold-500 transition-colors font-bold">+1 250-981-5662</a>
              </div>
              <div>
                <Send className="w-6 h-6 text-gold-500 mx-auto mb-2" />
                <a href="mailto:northernpropertymaintenancepg@gmail.com" className="text-earth-900 hover:text-gold-500 transition-colors">northernpropertymaintenancepg@gmail.com</a>
              </div>
            </div>
          </div>
        </div>
...
const ContactPage = () => (
  <>
    <PageMeta
      title="Contact & Free Quote – Northern Property Maintenance"
      description="Contact us for a free quote! Phone: +1 (250) 981-5662. We're happy to discuss your property maintenance needs."
      keywords="contact property maintenance, free quote yard care, Northern Property Maintenance contact"
    />
    <PageHeader
      title="Contact"
            ...
            <div className="space-y-6 md:space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Serving Prince George & Surrounding Areas<br />Prince George, College Heights, The Hart</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+12509815662" className="text-earth-900 hover:text-gold-500 transition-colors font-bold text-lg">+1 (250) 981-5662</a>
              ...
              <div className="pt-6">
                ...
                <div className="flex space-x-4">
                  <a
                    href="https://www.facebook.com/profile.php?id=61586315857028"
                    target="_blank"
                    rel="noopener noreferrer"
...
/*
// Blog List Page & Post Page removed/disabled
*/
...
const FullGalleryPage = () => {
  ...
  // SEO effect
  useEffect(() => {
    document.title = "Gallery – Our Work in Pictures | Northern Property maintenance";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', "Browse through our image gallery: Lawn care, seasonal cleanups, pressure washing and more from Prince George and surroundings.");
  }, []);

  const allGalleryImages: ProjectImage[] = [
    { id: '1', url: img1, title: 'Lawn Mowing' },
    { id: '2', url: img2, title: 'Seasonal Cleanup' },
    { id: '3', url: img5, title: 'Property Maintenance' },
    { id: '4', url: img6, title: 'Yard Care' },
    { id: '5', url: img7, title: 'Spring Cleanup' },
    { id: '6', url: img8, title: 'Commercial Service' },
    { id: '7', url: img9, title: 'Landscape Care' },
    { id: '8', url: img11, title: 'Property Reset' },
    { id: '9', url: img14, title: 'Pressure Washing' },
    { id: '10', url: img20, title: 'Hedge Trimming' },
    { id: '11', url: img23, title: 'Maintained Lawn' },
  ];
          ...
          <div className="mt-20 md:mt-28 p-8 md:p-12 bg-stone-50 border-l-4 border-gold-500 rounded-lg">
            <div className="max-w-3xl">
              ...
              <p className="text-gray-600 text-base md:text-lg mb-6 leading-relaxed">
                Every project in this gallery showcases our commitment to quality craftsmanship and beautiful property maintenance. From seasonal cleanups and lawn care to professional pressure washing and gutter cleaning – discover the possibilities for keeping your property in top shape in Prince George and surrounding areas.
              </p>
